...
class UpdateProgram extends Component {
    ...
    ProgramService.getProgramById(this.state.programId).then((res) =>{
            ...
            programEligibility:program.programEligibility,
    ...
    updateProgram = (e) => {
        ...
        ProgramService.updateProgram(program,this.state.programId).then((res) => {
                ...
                <div className="container" style={{marginBottom:"50px", marginTop:"50px"}}>
                    <div className="row">
                        <div className="card border-dark col-md-6 offset-md-3 offset-md-3 bg-light">
                            <h3 className="text-center">Update Program Status</h3>
                            <div className="card-body">
                                <form>
                                    ...
                                    <button className="btn btn-primary float-right" onClick={this.updateProgram}> Save</button>
